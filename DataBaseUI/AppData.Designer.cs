...
namespace DataBaseUI {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            private global::System.Data.DataColumn columnEployeeID;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public global::System.Data.DataColumn EployeeIDColumn {
                get {
                    return this.columnEployeeID;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(string FullName, string PhoneNumber, string Email, string Address, byte[] Image) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow FindByEployeeID(int EployeeID) {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            internal void InitVars() {
                this.columnEployeeID = base.Columns["EployeeID"];
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            private void InitClass() {
                this.columnEployeeID = new global::System.Data.DataColumn("EployeeID", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnEployeeID);
                ...
                this.Constraints.Add(new global::System.Data.UniqueConstraint("Constraint1", new global::System.Data.DataColumn[] {
                                this.columnEployeeID}, true));
                this.columnEployeeID.AutoIncrement = true;
                this.columnEployeeID.AutoIncrementSeed = 1;
                this.columnEployeeID.AllowDBNull = false;
                this.columnEployeeID.Unique = true;
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public int EployeeID {
                get {
                    return ((int)(this[this.tableEmployees.EployeeIDColumn]));
                }
                set {
                    this[this.tableEmployees.EployeeIDColumn] = value;
                }
            }
...
namespace DataBaseUI.AppDataTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("EployeeID", "EployeeID");
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`EployeeID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_EployeeID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "EployeeID", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`FullName`, `PhoneNumber`, `Email`, `Address`, `Image`) " +
                "VALUES (?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `FullName` = ?, `PhoneNumber` = ?, `Email` = ?, `Address` = ?, `Image` = ? WHERE ((`EployeeID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_EployeeID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "EployeeID", global::System.Data.DataRowVersion.Original, false, null));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataBaseUI.Properties.Settings.Default.mydbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EployeeID, FullName, PhoneNumber, Email, Address, [Image] FROM Employees";
        ...
        public virtual int Delete(int Original_EployeeID, string Original_FullName, string Original_PhoneNumber, string Original_Email, string Original_Address) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_EployeeID));
        ...
        public virtual int Update(string FullName, string PhoneNumber, string Email, string Address, byte[] Image, int Original_EployeeID, string Original_FullName, string Original_PhoneNumber, string Original_Email, string Original_Address) {
            if ((FullName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_EployeeID));
            if ((Original_FullName == null)) {
